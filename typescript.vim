...
syntax match typescriptNoise /\%(:\|,\|\;\|\.\)/

"" Programm Keywords"{{{
syntax keyword typescriptSource import export from as default contained
syntax region typescriptImportContainer start="^\s\?import \?" end=";\|$" contains=typescriptSource,typescriptLineComment,typescriptComment,typescriptStringS,typescriptStringB,typescriptStringD,typescriptBraces
syntax region typescriptExportContainer start="^\s\?export \?" end="$" contains=typescriptSource,typescriptComment,typescriptStringS,typescriptStringB,typescriptStringD,typescriptRegexpString,typescriptNumber,typescriptFloat,typescriptIdentifier,typescriptOperator,typescriptBoolean,typescriptNull,typescriptArrowFunction,typescriptGlobalObjects,typescriptExceptions,typescriptDomErrNo,typescriptDomNodeConsts,typescriptHtmlEvents,typescriptDotNotation,typescriptBraces,typescriptParens,typescriptBranch,typescriptClass,typescriptPrototype,typescriptBuiltins,typescriptNoise,typescriptFuncKeyword,typescriptFunction,typescriptVars,typescriptParameters,typescriptType,typescriptOpSymbols,typescriptReserved
"jsFuncCall
...
syntax keyword typescriptClass extends class

syntax keyword typescriptGlobalObjects Array Boolean Date Function Infinity Math Number NaN Object Packages RegExp String Symbol netscape Promise

syntax keyword typescriptExceptions try catch throw finally Error EvalError RangeError ReferenceError SyntaxError TypeError URIError

syntax keyword typescriptBuiltins decodeURI decodeURIComponent encodeURI encodeURIComponent eval isFinite isNaN parseFloat parseInt uneval
...
syntax keyword typescriptReserved constructor declare interface module abstract enum int short byte long char final native synchronized float package throws goto private transient debugger implements protected volatile double public type namespace
"}}}
...
" typescript Objects"{{{
  ...
  syn region typescriptVars start="(" end=")" contained contains=typescriptParameters,typescriptArrowFunction transparent keepend
...
syn match typescriptInterfaceCombinations "\(&\)\|\(|\)"
...
"  HiLink typescriptEndColons Exception
  ...
  HiLink typescriptInterfaceCombinations Operator
  HiLink typescriptBraces Function
  HiLink typescriptArrowFunction Function
"  HiLink typescriptParens Operator
  HiLink typescriptParens BlockDefine
  ...
  HiLink typescriptClass Keyword
